...
plt.text(0.95, 0.95, 'CatBoost', horizontalalignment='right', verticalalignment='top', transform=ax.transAxes, fontsize=12, fontweight='bold')
...
#by using print option you can see matrix

#mva output distirbutions
