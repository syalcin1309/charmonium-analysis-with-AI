...
clf=XGBClassifier(objective='binary:logistic',n_estimators=500,learning_rate=0.2,random_state=49)
#model training
...
plt.text(0.95, 0.95, 'XGBoost', horizontalalignment='right', verticalalignment='top', transform=ax.transAxes, fontsize=12, fontweight='bold')
